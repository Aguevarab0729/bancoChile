...
class Form2 extends Component {
  render() {
    ...
    <div className='formularioArchivos'>   
    <Form >
      <Form.Group>
      <Form.File id="exampleFormControlFile1" label="Informe de títulos, firmado con FEA por el abogado a cargo de los títulos" />
      </Form.Group>
      <Form.Group>
      <Form.File id="exampleFormControlFile1" label="Copia de inscripción de dominio del inmueble" />
      </Form.Group>
      <Form.Group>
      <Form.File id="exampleFormControlFile1" label="Certificado de hipotecas y gravámenes" />
      </Form.Group>
      <Form.Group>
      <Form.File id="exampleFormControlFile1" label="Certificado de avalúo fiscal" />
      </Form.Group>
      <Form.Group>
      <Form.File id="exampleFormControlFile1" label="Títulos anteriores" />
      </Form.Group>
      <Form.Group>
      <Form.File id="exampleFormControlFile1" label="Certificado de no expropiación Serviu y Municipal" />
      </Form.Group>
      </Form>
    </div>
    </React.Fragment>
